    ...
    <>
      ...
      <div className="lg:flex-grow md:w-1/2 lg:pr-24 md:pr-16 flex flex-col md:items-start md:text-left mb-16 md:mb-0 items-center text-center">
        ...
        <p className="mb-8 leading-relaxed">
          ...
          정보처리기사 필기 시험에 합격 후 다음 실기 시험을 준비하고 있습니다.
          또한, 방송통신대학교 컴퓨터과학과 4학년에 재학 중이며, CS(컴퓨터 공학)
          기초 지식을 쌓으며 다가오는 2025년도에 졸업을 앞두고 있습니다.
          앞으로도 프론트엔드 개발자로서 끊임없이 성장하며, 새로운 기술과 도구를
          익혀나갈 것입니다. 특히, 프론트엔드뿐 아니라 백엔드 및 CS 지식 기반을
          활용해 협업 효율성을 높이고, 사용자 중심의 웹 애플리케이션을 개발하여
          더 나은 경험을 제공하는 데 힘쓰겠습니다. 궁극적으론 Next.js와 Spring
          Boot를 활용해 풀스택 개발자가 되는것이 저의 목표입니다. 더 나은
